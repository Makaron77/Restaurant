			...
			<div className='header__container'>
				<div className='header__line'>
					...
					<div className='header__basket'>
						<a href='#'>
							<svg
								...
								height='1698.268px'
								// className='enable-background: new 0 0 1489.733 1698.268'
								version='1.1'
					...
					<div className='header__contacts'>
						<div className='header__contacts--numPhone'>
							<div className='header__contacts--images'>
								<svg
									className='header__contacts--svg'
									viewBox='0 0 24 24'
									xmlns='http://www.w3.org/2000/svg'
								>
					...
					<div className='header__burgerMenu'>
						<svg
							className='header__burgerMenu--svg'
							width='31'
							height='18'
							viewBox='0 0 31 18'
							fill='none'
